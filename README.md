...
[English](#english-home) | [中文](#chinese-home)
...
*39 个项目 · 8 个类别 · 端到端 AI Scientist · 实验循环 · 科研副驾 · 技能包 · 论文工具 · 基准评测*
...
> 截至 2026-03-22，当前共收录 **39 个项目**。

---

<a id="quick-guide-zh"></a>
## 快速导航

| 如果你想要…… | 先看这里 |
| --- | --- |
| 全自动跑通 idea → paper | [端到端 AI Scientists](#end-to-end-ai-scientists-zh) |
| 夜间自动优化代码指标 | [实验优化循环](#experiment-optimization-loops-zh) |
| 找一个 AI 科研副驾 | [科研副驾与交互式智能体](#research-co-pilots--interactive-agents-zh) |
| 搭一个科研工作台 | [科研工作台](#research-workspaces-zh) |
| 给你的 agent 加科研技能 | [技能与工作流包](#skill--workflow-packs-zh) |
| 搜论文或自动出图 | [文献检索、引文与论文工具](#literature-search-citation--paper-tools-zh) |
| 深入生物医药方向 | [垂直领域智能体](#vertical-domain-agents-zh) |
| 评估 AI 的科研质量 | [基准与评测](#benchmarks--evaluation-zh) |

<!-- Hidden for now: | 搭 agent 基础设施 | [Agent Infrastructure & Runtimes](#agent-infrastructure--runtimes-zh) | -->

<a id="contents-zh"></a>
## 目录

- [值得关注的人](#people-to-follow-zh)
- [项目类型概览](#project-type-overview-zh)
- [分类表格](#category-tables-zh)
- [活动与会议](#events--conferences-zh)
- [X 新闻与趋势](#x-news--trends-zh)
- [相关列表](#related-lists-zh)
- [贡献与推荐](#contributing-zh)

---

<a id="people-to-follow-zh"></a>
## 值得关注的人
...
<a id="project-type-overview-zh"></a>
## 项目类型概览

| 类别 | 数量 | 代表项目 |
| --- | ---: | --- |
| 端到端 AI Scientists | 7 | AI-Scientist, AutoResearchClaw, Kosmos, NanoResearch |
...
<a id="end-to-end-ai-scientists-zh"></a>
### 端到端 AI Scientists
...
<a id="experiment-optimization-loops-zh"></a>
### 实验优化循环
...
<a id="research-co-pilots--interactive-agents-zh"></a>
### 科研副驾与交互式智能体
...
<a id="skill--workflow-packs-zh"></a>
### 技能与工作流包
...
<!--
<a id="agent-infrastructure--runtimes-zh"></a>
### Agent 基础设施与运行时
...
<a id="literature-search-citation--paper-tools-zh"></a>
### 文献检索、引文与论文工具
...
<a id="vertical-domain-agents-zh"></a>
### 垂直领域智能体
...
<a id="benchmarks--evaluation-zh"></a>
### 基准与评测
